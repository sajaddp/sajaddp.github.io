...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ app()->getLocale() === 'fa' ? 'rtl' : 'ltr' }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} - ویدیوها</title>
        ...
        <div class="relative min-h-screen overflow-hidden">
            ...
            <div class="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-12 px-6 py-10 lg:gap-16 lg:py-14">
                    ...
                    <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex flex-wrap items-center gap-3 pt-2">
                                ...
                                <a class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-900 transition hover:-translate-y-0.5 hover:border-emerald-200 hover:text-emerald-700" href="{{ route('home') }}">
                                    بازگشت به خانه
                                </a>
                            </div>
                        </div>
                        <div class="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-xl">
                            <div class="flex flex-col gap-4">
                                <div class="flex items-center justify-between">
                                    <span class="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-700">پخش دوگانه</span>
                                    <span class="rounded-full bg-cyan-50 px-3 py-1 text-[11px] font-semibold text-cyan-800 ring-1 ring-cyan-200">YouTube + Aparat</span>
                                </div>
                                <div class="flex items-center justify-between gap-3 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
                                    <div class="flex flex-col gap-1">
                                        <span class="text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-700">بدون لاگین</span>
                                        <span class="text-lg font-bold text-slate-900">پخش مستقیم روی هر دستگاه</span>
                                    </div>
                                    <span aria-hidden="true" class="text-xl text-cyan-700">&rarr;</span>
                                </div>
                                <p class="text-xs text-slate-600">برای جزئیات بیشتر و فایل های ضمیمه، به صفحه اختصاصی ویدیو برو.</p>
                            </div>
                        </div>
                    </div>
                </header>
                ...
                <footer class="flex flex-wrap items-center justify-between gap-3 border-t border-slate-200 pt-6 text-xs text-slate-600">
                    <span>برای مشاهده منبع اصلی از صفحه هر ویدیو وارد شو.</span>
