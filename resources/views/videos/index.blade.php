            ...
            <div class="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-12 px-6 py-12 lg:gap-16 lg:py-16">
                <header class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-3">
                        <p class="text-sm font-semibold uppercase tracking-[0.3em] text-slate-500">آرشیو کامل ویدیوها</p>
                        <h1 class="text-4xl font-semibold leading-tight text-slate-950 sm:text-5xl">گالری کامل آموزش ها</h1>
                        <p class="max-w-2xl text-base text-slate-600">تمام ویدیوهای منتشر شده را با صفحه اختصاصی هر ویدیو مشاهده کن.</p>
                    </div>
                </header>
