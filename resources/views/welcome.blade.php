...
{!! json_encode($jsonLd, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) !!}
    ...
    <body class="min-h-screen bg-slate-50 text-right text-slate-900 antialiased">
        <div class="relative min-h-screen overflow-hidden">
            ...
            <div class="pointer-events-none absolute -left-28 top-10 h-72 w-72 rounded-full bg-emerald-200/40 blur-3xl"></div>
            <div class="pointer-events-none absolute -right-16 bottom-24 h-80 w-80 rounded-full bg-cyan-200/40 blur-3xl"></div>
            <div class="pointer-events-none absolute inset-x-10 top-24 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent"></div>
            ...
            <div class="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col gap-12 px-6 py-10 lg:gap-16 lg:py-14">
                <header class="flex flex-col gap-8">
                    <nav class="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white/90 px-5 py-3 shadow-xl backdrop-blur">
                    ...
                    <div class="grid gap-10 lg:grid-cols-12 lg:items-center">
                        <div class="flex flex-col gap-5 lg:col-span-7">
                            ...
                            <h1 class="text-4xl font-bold leading-tight text-slate-950 sm:text-5xl">
                                آموزش‌های ویدیویی Laravel و PHP، با استانداردی در حد یک استودیوی حرفه‌ای.
                            </h1>
                            <p class="max-w-3xl text-base leading-relaxed text-slate-600">
                                مسیرهای یادگیری کامل، از مقدمات تا استقرار. همه محتوا بدون نیاز به ثبت‌نام قابل مشاهده است و می‌توانید مستقیماً وارد صفحه هر دوره یا ویدیو شوید.
                            </p>
                            <div class="grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
                                <div class="flex items-center gap-2 rounded-xl bg-white px-3 py-2 ring-1 ring-slate-200">
                                    ...
                                    مرور سریع آخرین دوره‌ها و ویدیوهای منتشر شده
                                </div>
                                <div class="flex items-center gap-2 rounded-xl bg-white px-3 py-2 ring-1 ring-slate-200">
                                    <span class="h-2 w-2 rounded-full bg-cyan-500"></span>
                                    محیط روشن، خوانا و مناسب تماشای طولانی‌مدت
                                </div>
                            </div>
                            ...
                            <div class="relative overflow-hidden rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-2xl backdrop-blur">
                                ...
                                <div class="relative flex flex-col gap-4">
                                    ...
                                    <div class="grid grid-cols-3 gap-2 text-center text-xs">
                                        <div class="rounded-xl bg-emerald-50 px-3 py-2 text-emerald-700 ring-1 ring-emerald-200">
                                            <div class="text-lg font-bold text-slate-900">{{ count($courses) }}</div>
                                            دوره فعال
                                        </div>
                                        <div class="rounded-xl bg-cyan-50 px-3 py-2 text-cyan-700 ring-1 ring-cyan-200">
                                            <div class="text-lg font-bold text-slate-900">{{ $totalVideos }}</div>
                                            ویدیو آنلاین
                                        </div>
                                        <div class="rounded-xl bg-amber-50 px-3 py-2 text-amber-700 ring-1 ring-amber-200">
                                            <div class="text-lg font-bold text-slate-900">هفتگی</div>
                                            آپدیت محتوا
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-3 rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200">
                                        <div class="flex items-center justify-between text-xs font-semibold text-slate-700">
                                            <span>جدیدترین پخش ها</span>
                                            <span class="text-emerald-700">در حال بروزرسانی</span>
                                        </div>
                ...
                <section class="rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-lg">
                    <div class="flex flex-col gap-3">
                        <p class="text-sm font-semibold uppercase tracking-[0.32em] text-emerald-700">همراه تیم فنی بمان</p>
                        <h2 class="text-3xl font-bold text-slate-900">برنامه ریزی کن، منتشر کن و به رقابت با Laracasts ادامه بده.</h2>
                        <p class="mx-auto max-w-3xl text-sm leading-relaxed text-slate-600">
                            مسیرهای یادگیری، جزئیات هر ویدیو و مدیریت فایل ها را از پنل ادمین کنترل کن. کاربران بدون لاگین هم یک تجربه حرفه ای خواهند داشت.
                        </p>
